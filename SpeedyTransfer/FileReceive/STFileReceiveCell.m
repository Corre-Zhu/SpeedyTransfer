...
- (void)configCell {
    ...
    if (_transferInfo.transferStatus == STFileTransferStatusReceiving) {
        succeedImageView.hidden = YES;
        failedLabel.hidden = YES;
    } else if (_transferInfo.transferStatus == STFileTransferStatusReceiveFailed) {
        succeedImageView.hidden = YES;
        failedLabel.hidden = NO;
    } else if (_transferInfo.transferStatus == STFileTransferStatusReceived) {
